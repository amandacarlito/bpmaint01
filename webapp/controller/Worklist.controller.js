sap.ui.define([
    ...
    return BaseController.extend("bpmaint01.bpmaint01.controller.Worklist", {
        ...
        onSavePress: function () {
            ...
            if (oJson.PartnerType == '') {
                ...
                oModel.create("/BusinessPatnerSet", oJson, {
                    success: (oData) => {
        ...
        _showObject : function (oItem) {
            this.getRouter().navTo("object", {
                objectId: oItem.getBindingContext().getPath().substring("/BusinessPatnerSet".length)
            });
        },
        ...
        _getDialog: function () {
            if (!this._oDialog) {
                this._oDialog = sap.ui.xmlfragment("bpmaint01.bpmaint01.view.fragment.New", this);
