		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bpmaint01bpmaint01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpmaint01bpmaint01-display": {
								"semanticObject": "bpmaint01bpmaint01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpmaint01.bpmaint01",
									"url": sap.ui.require.toUrl("bpmaint01/bpmaint01")
								}
							}
						}
					}
